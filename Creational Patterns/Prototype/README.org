...
The prototype pattern is a [[id:7b8fa54f-c997-4476-a768-77f349bf6129][creational pattern]] that specifies the kinds of objects to create using a prototypical instance, and create new
